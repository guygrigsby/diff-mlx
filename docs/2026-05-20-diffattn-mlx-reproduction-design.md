...
**Status update 2026-05-22:** Project scope revised after Stage 1 throughput measurement. Paper-scale Stage 1/2 runs (2B / 4B tokens) descoped. New deliverables: MLX implementation (done), Phase C custom Metal kernels, reduced Stage 1 paired at 200M tokens. See `docs/2026-05-22-stage1-pivot-retro.md` for the why and `docs/2026-05-22-phase-c-plan.md` for the active plan. Sections below describe the original design; kernel specs in §5.1, §5.1b, §7 remain load-bearing. Stage 1/2 token counts in §5 are aspirational and should be read against the pivot retro.
